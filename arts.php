...
<section class="course" id="course">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="content">
                <a href="bba_sem.php" class="title">Bachelor of Business Administration (BBA)</a>
                <div class="info">
                    <h3> <i class="far fa-calendar-alt"></i> 6 semesters </h3>
                </div>    
            </div>
        </div> 
        ...
        <div class="box">
            <div class="content">
                <a href="bmm_sem.php" class="title">Bachelor of Mass Media (BMM)</a>
                <div class="info">
                    <h3> <i class="far fa-calendar-alt"></i> 6 semesters </h3>
                </div>    
            </div>
