...
<section class="notes">
    <h1> Study material for BSc.IT Sem 3</h1>

    <div class="row">
        <div class="notes-col">
            <img src="images/not.png">
            <div class="layer">
                <h3><a href="bsc_it3_n.php"> NOTES </a></h3>
            </div>
        </div>
        ...
        <div class="notes-col">
            ...
            <div class="layer">
                <h3><a href="bsc_it3_v.php"> VIDEOS </a></h3>
            </div>
        </div>
        ...
        <div class="notes-col">
            ...
            <div class="layer">
                <h3><a href="bsc_it3_ts.php"> TEST PAPERS & SOLUTIONS </a></h3>
            </div>
        </div>
    </div>
