...
<section class="sem">
    ...
    <div class="row">
        <div class="sem-col">
            <h3><a href="a_bsc_it1_notes.html"> semester 1 </a></h3> 
        </div>

        <div class="sem-col">
            <h3><a href="bsc_it2_notes.php"> semester 2 </a></h3> 
        </div>

        <div class="sem-col">
            <h3><a href="bsc_it3_notes.php"> semester 3 </a></h3> 
        </div>

    </div>
    <div class="row">
        <div class="sem-col">
            <h3><a href="bsc_it4_notes.php"> semester 4 </a></h3> 
        </div>

        <div class="sem-col">
            <h3><a href="bsc_it5_notes.php"> semester 5 </a></h3> 
        </div>

        <div class="sem-col">
            <h3><a href="bsc_it6_notes.php"> semester 6 </a></h3> 
        </div>
