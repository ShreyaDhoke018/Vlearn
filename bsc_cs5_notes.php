...
<section class="notes">
    <h1> Study material for BSc.CS Sem 5</h1>

    <div class="row">
        <div class="notes-col">
            <img src="images/not.png">
            <div class="layer">
                <h3><a href="bsc_cs5_n.php"> NOTES </a></h3>
            </div>
        </div>
        ...
        <div class="notes-col">
            ...
            <div class="layer">
                <h3><a href="bsc_cs5_v.php"> VIDEOS </a></h3>
            </div>
        </div>
        ...
        <div class="notes-col">
            ...
            <div class="layer">
                <h3><a href="bsc_cs5_ts.php"> TEST PAPERS & SOLUTIONS </a></h3>
            </div>
        </div>
    </div>
