...
<!--custom css file link-->
    <link rel="stylesheet" href="a_styleviewfile.css">
...
<header>
	...
	<a href="a_it_uploadfile.php"><button class="btn-n">Upload Files</button></a>
	<a href="deletepage.php"><button class="btn-n">Delete Files</button></a>
</body>
</html>
<?php

$files = scandir("it_upload");
for ($a = 2; $a < count($files); $a++){
	//displaying links to download
	//making it downloadable
	?>
	<p class="p1">
		<a  download="<?php echo  $files[$a]?>" href="it_upload/<?php echo  $files[$a]?>"><?php echo $files[$a]?></a>
	</p><br>
	<?php
}
?>