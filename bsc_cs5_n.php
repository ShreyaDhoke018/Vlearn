...
<header>
	...
	<a href="cs_uploadfile.php"><button class="btn-n">Upload Files</button></a>
</body>
</html>
<?php

$files = scandir("cs_upload");
for ($a = 2; $a < count($files); $a++){
	//displaying links to download
	//making it downloadable
	?>
	<p class="p1">
		<a  download="<?php echo  $files[$a]?>" href="cs_upload/<?php echo  $files[$a]?>"><?php echo $files[$a]?></a>
	</p><br>
	<?php
}
?>