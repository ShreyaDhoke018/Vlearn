...
<section class="sem">
    ...
    <div class="row">
        <div class="sem-col">
            <h3><a href="bsc_ds1_notes.php"> semester 1 </a></h3> 
        </div>

        <div class="sem-col">
            <h3><a href="bsc_ds2_notes.php"> semester 2 </a></h3> 
        </div>

        <div class="sem-col">
            <h3><a href="bsc_ds3_notes.php"> semester 3 </a></h3> 
        </div>

    </div>
    <div class="row">
        <div class="sem-col">
            <h3><a href="bsc_ds4_notes.php"> semester 4 </a></h3> 
        </div>

        <div class="sem-col">
            <h3><a href="bsc_ds5_notes.php"> semester 5 </a></h3> 
        </div>

        <div class="sem-col">
            <h3><a href="bsc_ds6_notes.php"> semester 6 </a></h3> 
        </div>
